        ...
        <div className="max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            <motion.h1 
              ...
              className="text-5xl font-bold tracking-tight text-amber-900 sm:text-6xl relative inline-block"
            >
            ...
            <motion.p 
              ...
              className="mt-6 text-xl text-amber-800"
            >
              ...
              <div className="flex items-center">
                <motion.span 
                  ...
                  className="flex items-center justify-center w-12 h-12 rounded-full 
                   bg-yellow-100 text-yellow-500 font-bold text-xl mr-4"
                >
                  {activeTab + 1}
                </motion.span>
                <div>
                  <motion.h2 
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5 }}
                    className="text-3xl font-bold text-amber-900 relative inline-block"
                  >
                    {groupTitle}
                    <motion.div 
                      variants={underlineVariants}
                  ...
                  {groupDescription && (
                    <motion.p 
                      ...
                      className="text-amber-800 mt-2 text-lg"
                    >
                      {groupDescription}
                    </motion.p>
                  )}
                    ...
                    <div className="relative flex flex-col h-full p-6">
                      ...
                      <div className="mt-auto flex justify-between items-center">
                        ...
                        <motion.span
                          ...
                          animate={{ 
                            opacity: hoveredCard === itemIdx ? 1 : 0,
                            scale: hoveredCard === itemIdx ? 1 : 0.8
                          }}
                          className="text-xs font-medium px-2.5 py-0.5 rounded-full bg-yellow-100 text-amber-800"
                        >
                          Enroll now
                        </motion.span>
                      </div>
