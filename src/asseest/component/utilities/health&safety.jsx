...
const HealthSafety = () => {
  ...
  const SectionHeader = ({ icon, title }) => {
    ...
    return (
      <div ref={ref} className="flex items-center mb-8">
        ...
        <div className="relative">
          ...
          <motion.span
            ...
            className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-1/4 h-1 bg-amber-400 rounded-lg">
          </motion.span>
        </div>
      </div>
    );
    ...
    <div className="bg-gradient-to-br from-amber-50 to-amber-100 font-['Arial_Narrow',_sans-serif] text-amber-800">
        ...
        <div className="absolute inset-0 bg-amber-900 bg-opacity-30 flex items-center justify-center">
          <div className="text-center px-6">
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="text-4xl md:text-5xl font-extrabold text-white mb-4 drop-shadow-lg relative"
            >
            ...
            <motion.p
              ...
              initial="hidden"
              animate="visible"
              className="text-xl text-amber-100 max-w-3xl mx-auto drop-shadow-md mt-6">
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-16 -mt-20 relative z-10">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-amber-200">
            ...
            <AnimatedComponent variants={{}} className="flex flex-wrap gap-4 justify-center">
              {['Hospitals & Clinics', 'Nursing Homes', 'Diagnostic Laboratories', 'Pharmaceutical Companies', 'Medical Device Manufacturers', 'Healthcare IT Providers', 'Dental Practices', 'Rehabilitation Centers'].map((item, index) => (
                <motion.span
                  ...
                  initial="hidden"
                  animate="visible"
                  className="bg-amber-100 text-amber-900 px-5 py-2 rounded-full font-medium text-lg hover:bg-amber-200 hover:shadow-sm transition-all duration-300 cursor-default"
                >
                  {item}
                </motion.span>
              ))}
                ...
                <AnimatedComponent key={index} variants={animationVariants.scaleUp}>
                  ...
                  >
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="text-xl font-semibold text-amber-900 mb-1">{doc.title}</h3>
                        <p className="text-amber-700">{doc.description}</p>
                      </div>
                    </div>
                  </motion.div>
                </AnimatedComponent>
          ...
          {/* Video Guide Section */}
          <section className="px-8 py-12 sm:px-12 bg-amber-100/50 text-center transition-colors duration-300">
            ...
            <AnimatedComponent variants={animationVariants.scaleUp}>
              <div className="aspect-w-16 aspect-h-9 bg-amber-200/60 rounded-xl overflow-hidden flex items-center justify-center relative group border border-amber-200 hover:shadow-md hover:border-amber-300 transition-all duration-300 cursor-pointer">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-20 h-20 bg-amber-100 rounded-full flex items-center justify-center group-hover:bg-white group-hover:scale-105 transition-all duration-300 shadow-md">
