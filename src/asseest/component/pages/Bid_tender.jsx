  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 font-sans bg-white overflow-hidden">
      ...
      <AnimatedSection delay={0.5}>
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-gray-900 to-blue-900 text-white p-12 text-center">
          {/* Animated background */}
          <motion.div 
            className="absolute inset-0 opacity-50"
            style={{
              backgroundImage: 'radial-gradient(circle at 75% 30%, rgba(59, 130, 246, 0.3) 0%, transparent 30%), radial-gradient(circle at 25% 70%, rgba(245, 158, 11, 0.3) 0%, transparent 30%)'
            }}
            animate={{
              backgroundPosition: ['0% 0%', '100% 100%'],
            }}
          ...
          <div className="relative z-10">
            ...
            <motion.h2 
              ...
              viewport={{ once: true }}
            >
              Create <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-amber-400">Cinematic</span> Technical Proposals
            </motion.h2>
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              Our experts help you craft ISO-compliant, visually stunning bids that stand out in competitive tenders
            </motion.p>
            ...
            >
              ...
              >
                <span className="flex items-center justify-center">
                  <span className="mr-2">🎬</span> Schedule Demo
                </span>
              </InteractiveButton>
              ...
              >
                <span className="flex items-center justify-center">
                  <span className="mr-2">📥</span> Download Interactive Templates
                </span>
              </InteractiveButton>
            </motion.div>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <div className="flex items-center space-x-4 bg-white bg-opacity-10 px-6 py-3 rounded-full backdrop-blur-sm border border-white border-opacity-20">
                <motion.div
                  animate={{
                    rotate: [0, 10, -10, 0]
                  }}
                ...
                <span className="text-sm">Trusted by Fortune 500 companies worldwide</span>
              </div>
            </motion.div>
          </div>
        </div>
