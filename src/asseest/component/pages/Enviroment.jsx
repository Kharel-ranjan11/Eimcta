...
const EnvironmentalServices = () => {
  return (
    <div className="bg-white text-gray-800 px-4 py-8 md:px-8 lg:px-20 max-w-7xl mx-auto">
      ...
      >
        <motion.h1 
          className="text-3xl md:text-5xl font-bold text-green-700 mb-4"
      ...
      {/* EIA Section */}
      <motion.section 
        className="mb-16 bg-green-50 rounded-xl p-6 md:p-8 shadow-sm"
        initial="hidden"
        whileInView="visible"
      ...
      {/* Standards Section */}
      <motion.section 
        className="mb-16 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-8"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={containerVariants}
      >
        <motion.h2 
          ...
          variants={itemVariants}
        >
          Aligned with <span className="text-green-700">International Standards</span>
        </motion.h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <motion.div 
              key={index}
              className="bg-white p-5 rounded-lg shadow-sm text-center hover:shadow-md transition-shadow"
              variants={itemVariants}
              whileHover={{ y: -5 }}
              custom={index}
            >
      ...
      {/* CTA Section */}
      <motion.section 
        className="bg-green-700 rounded-xl p-8 md:p-12 text-white"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={containerVariants}
      >
        ...
        >
          ...
          >
            ...
            <motion.button 
              className="border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-600 transition-colors"
              variants={itemVariants}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
