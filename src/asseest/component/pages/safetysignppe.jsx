...
const SectionHeader = ({ title }) => {
    ...
    return (
        <div ref={ref} className="text-center mb-12">
            <h2 className={`relative inline-block text-3xl font-bold text-amber-900 transition-all duration-1000 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                {title}
                <span 
    ...
    <div className="mt-20 text-center">
      ...
      <div className="relative aspect-video max-w-4xl mx-auto rounded-xl shadow-2xl overflow-hidden bg-gray-900 border-4 border-amber-200">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 ml-1" viewBox="0 0 20 20" fill="currentColor">
...
const industrySectors = [
  ...
  { icon: <Zap className="w-6 h-6" />, name: "Energy" },
  { icon: <Shirt className="w-6 h-6" />, name: "Textile" },
  { icon: <Mountain className="w-6 h-6" />, name: "Mining" },
  { icon: <Building className="w-6 h-6" />, name: "Corporate Offices" },
  { icon: <Hammer className="w-6 h-6" />, name: "Construction" },
  { icon: <Droplets className="w-6 h-6" />, name: "Oil & Gas" },
];

const signCategories = [
  { id: 1, icon: <TriangleAlert className="w-12 h-12" />, title: "Danger Signs", description: "Indicates immediate danger that will cause death or serious injury if not avoided.", iso: "ISO 7010 W001", examples: ["High voltage", "Radiation area", "Toxic material"], gradient: "bg-gradient-to-br from-red-600 to-red-800", sectors: ["Construction", "Manufacturing", "Energy"] },
  { id: 2, icon: <Ban className="w-12 h-12" />, title: "Prohibition Signs", description: "Indicates behavior or actions that are not permitted in the area.", iso: "ISO 7010 P001", examples: ["No smoking", "No entry", "No mobile phones"], gradient: "bg-gradient-to-br from-red-500 to-red-700", sectors: ["Healthcare", "Food Processing", "Chemical"] },
  { id: 3, icon: <TrafficCone className="w-12 h-12" />, title: "Mandatory Signs", description: "Indicates actions that must be carried out to comply with safety regulations.", iso: "ISO 7010 M001", examples: ["Wear PPE", "Wash hands", "Safety harness required"], gradient: "bg-gradient-to-br from-blue-600 to-blue-800", sectors: ["Construction", "Laboratories", "Manufacturing"] },
  { id: 4, icon: <Plus className="w-12 h-12" />, title: "Emergency Signs", description: "Indicates location of safety equipment or emergency exits.", iso: "ISO 7010 E001", examples: ["First aid kit", "Emergency exit", "Eyewash station"], gradient: "bg-gradient-to-br from-green-600 to-green-800", sectors: ["All industries"] },
  { id: 5, icon: <FireExtinguisher className="w-12 h-12" />, title: "Fire Safety Signs", description: "Indicates location of fire fighting equipment and fire alarm activation points.", iso: "ISO 7010 F001", examples: ["Fire extinguisher", "Fire hose", "Fire alarm call point"], gradient: "bg-gradient-to-br from-orange-600 to-orange-800", sectors: ["All industries"] },
  { id: 6, icon: <Radiation className="w-12 h-12" />, title: "Warning Signs", description: "Indicates potentially hazardous situations that may cause minor or moderate injury.", iso: "ISO 7010 W001", examples: ["Slippery surface", "Hot surface", "Forklift traffic"], gradient: "bg-gradient-to-br from-yellow-500 to-yellow-700", sectors: ["Warehousing", "Manufacturing", "Healthcare"] },
  { id: 7, icon: <Biohazard className="w-12 h-12" />, title: "Biological Hazard Signs", description: "Indicates presence of biological substances that pose a threat to health.", iso: "ISO 7010 W021", examples: ["Biohazard area", "Contaminated waste", "Infectious materials"], gradient: "bg-gradient-to-br from-purple-600 to-purple-800", sectors: ["Healthcare", "Laboratories", "Waste Management"] },
  { id: 8, icon: <Plus className="w-12 h-12" />, title: "Safe Condition Signs", description: "Indicates safe conditions or locations of safety-related facilities.", iso: "ISO 7010 E002", examples: ["Assembly point", "Safe route", "Emergency shower"], gradient: "bg-gradient-to-br from-green-500 to-green-700", sectors: ["All industries"] },
  { id: 9, icon: <Recycle className="w-12 h-12" />, title: "Environmental Signs", description: "Provides information about environmental protection and waste management.", iso: "ISO 7010 E003", examples: ["Recycling station", "Waste segregation", "Water conservation"], gradient: "bg-gradient-to-br from-teal-600 to-teal-800", sectors: ["All industries"] }
];

const ppeCategories = [
  { id: 1, icon: <HardHat className="w-12 h-12" />, title: "Head Protection", description: "Industrial helmets compliant with ANSI Z89.1/CSA Z94.1 standards for impact and electrical hazards.", standards: "EN 397, ANSI Z89.1", types: ["Hard Hats", "Bump Caps", "Welding Helmets"], gradient: "bg-gradient-to-br from-amber-500 to-amber-700", industries: ["Construction", "Mining", "Utilities"] },
  { id: 2, icon: <Glasses className="w-12 h-12" />, title: "Eye Protection", description: "Safety glasses and goggles meeting ANSI Z87.1 for impact, chemical splash, and optical radiation protection.", standards: "ANSI Z87.1, EN 166", types: ["Safety Glasses", "Goggles", "Face Shields"], gradient: "bg-gradient-to-br from-blue-600 to-blue-800", industries: ["Laboratories", "Healthcare", "Woodworking"] },
  { id: 3, icon: <Shield className="w-12 h-12" />, title: "Respiratory Protection", description: "NIOSH-approved respirators for particulate matter, gases, vapors, and oxygen-deficient environments.", standards: "NIOSH 42 CFR 84, EN 149", types: ["N95 Masks", "Half-face Respirators", "SCBA"], gradient: "bg-gradient-to-br from-gray-600 to-gray-800", industries: ["Healthcare", "Construction", "Mining"] },
  { id: 4, icon: <Footprints className="w-12 h-12" />, title: "Foot Protection", description: "Steel-toe boots and slip-resistant footwear for protection against crush injuries and slips.", standards: "ASTM F2413, EN ISO 20345", types: ["Steel Toe Boots", "Metatarsal Guards", "Slip-Resistant Shoes"], gradient: "bg-gradient-to-br from-slate-600 to-slate-800", industries: ["Construction", "Warehousing", "Manufacturing"] },
  { id: 5, icon: <UserRoundCog className="w-12 h-12" />, title: "Leg Protection", description: "Protective clothing including chaps and leg guards against cuts, abrasions, and chemicals.", standards: "EN 381, ANSI/ISEA 107", types: ["Leg Guards", "Chemical Pants", "Kevlar Chaps"], gradient: "bg-gradient-to-br from-indigo-600 to-indigo-800", industries: ["Forestry", "Chemical", "Construction"] },
  { id: 6, icon: <Ear className="w-12 h-12" />, title: "Hearing Protection", description: "Earplugs and earmuffs rated for occupational noise exposure per NRR requirements.", standards: "ANSI S3.19, EN 352", types: ["Earplugs", "Earmuffs", "Electronic Hearing Protectors"], gradient: "bg-gradient-to-br from-pink-600 to-pink-800", industries: ["Aviation", "Construction", "Metalwork"] },
  { id: 7, icon: <Hand className="w-12 h-12" />, title: "Hand Protection", description: "Gloves designed for protection against cuts, heat, chemicals, and electrical hazards.", standards: "EN 388, EN 374, ASTM D120", types: ["Cut-Resistant Gloves", "Chemical Gloves", "Heat-Resistant Gloves"], gradient: "bg-gradient-to-br from-red-600 to-red-800", industries: ["Glass Handling", "Chemical", "Welding"] },
  { id: 8, icon: <FlaskConical className="w-12 h-12" />, title: "Chemical Protection", description: "Specialized suits and gloves for handling hazardous materials and chemicals safely.", standards: "EN 943, NFPA 1991", types: ["Chemical Suits", "Respirators", "Splash Goggles"], gradient: "bg-gradient-to-br from-green-600 to-green-800", industries: ["Pharmaceutical", "Laboratory", "Chemical"] },
  { id: 9, icon: <Shirt className="w-12 h-12" />, title: "Body Protection", description: "Vests, jackets, and full-body suits to protect from visibility hazards and extreme conditions.", standards: "ANSI/ISEA 107, EN ISO 20471", types: ["Hi-Vis Vests", "Insulated Jackets", "Fire-Retardant Suits"], gradient: "bg-gradient-to-br from-cyan-600 to-cyan-800", industries: ["Traffic Control", "Utilities", "Emergency Services"] },
  { id: 10, icon: <Shield className="w-12 h-12" />, title: "Face Protection", description: "Face shields and masks to prevent exposure to splashes, flying debris, and biological hazards.", standards: "EN 166, ANSI Z87.1", types: ["Face Shields", "Surgical Masks", "Welding Helmets"], gradient: "bg-gradient-to-br from-purple-600 to-purple-800", industries: ["Healthcare", "Metalwork", "Laboratory"] }
];
